...
if (empty($paket_meta_aciklama)) {
    $paket_meta_aciklama = substr(strip_tags($paket_veri[0]['data']['diller']['tr']['aciklama'] ?? ''), 0, 160);
}
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12">
			...
			<h2 class="property_price"><?= htmlspecialchars($paket_veri[0]['data']['diller']['tr']['baslik'] ?? 'Başlık Güncelleniyor') ?> Detaylar</h2>
	<?php if ($vurgulama_yazi): ?>
                <span class="campaign-text">**  <?php echo htmlspecialchars($vurgulama_yazi); ?> ** </span>
				
                <?php endif; ?>	
				<p style="margin-bottom: 0px;"><b>Tur Kodu:</b> <?= htmlspecialchars($paket_veri[0]['data']['ortak_alanlar']['tur_kodu'] ?? '') ?></p>
      </div>
      <div class="col-lg-4">
...
<div class="tur-resim-container" style="position: relative; display: inline-block;">
    <img class="img-thumbnail" alt="<?= htmlspecialchars($paket_veri[0]['data']['diller']['tr']['baslik'] ?? 'Başlık Güncelleniyor') ?>" src="<?= $paket_resim_yolu ?>" style="margin-bottom: 15px;">

</div>         
 <h2 class="property_price"><?= htmlspecialchars($paket_veri[0]['data']['diller']['tr']['baslik'] ?? 'Başlık Güncelleniyor') ?> Fiyat Listesi</h2>
          <ul>
    ...
    <li style="font-weight: 600;">Bebek (Yataksız) 
        <span style="float: right;" class="property_price">
		  ...
		  <hr>
		  <p>Lütfen Bizimle İletişime Geçmekten Çekinmeyin. Düşüncelerinizi duymak ve aklınızdaki tüm soruları yanıtlamak isteriz.</p>
<?php 		
		...
		if ($kurumsalData) {?>		  
		 <div class="readmore" style="margin-bottom: 10px;">
			...
			<a href="https://wa.me/<?php echo formatWhatsAppNumber($kurumsalData['contact']['whatsapp']); ?>" target="_blank" style="padding: 8px 36px;background: #28a745; font-size: 17px; width: 100%; text-align: center; font-weight: 700;">
		 ...
		 <div class="readmore" style="margin-bottom: 10px;">
			...
			<a href="tel:<?php echo $kurumsalData['contact']['sabit-telefon']; ?>" target="_blank" style="padding: 8px 36px;background: blue; font-size: 17px; width: 100%; text-align: center; font-weight: 700;">
...
<?php } ?>		 
		 <div class="readmore" style="margin-bottom: 10px;">
			...
			<a href="#" data-toggle="modal" data-target="#bilgi-iste" style="padding: 8px 36px;font-size: 17px; width: 100%; text-align: center; font-weight: 700; background: #17a2b8;" > <i class="fas fa-envelope" aria-hidden="true"></i> Bilgi İsteyin </a>
		 ...
		 <div class="readmore" style="margin-bottom: 0px;">
			...
			<a href="#" data-toggle="modal" data-target="#yorum-yap" style="padding: 8px 36px;font-size: 17px; width: 100%; text-align: center; font-weight: 700;"><i class="fas fa-comment" aria-hidden="true"></i> Yorum Yapın </a>
...
$donus_aktif = ucus_kodu_aktif_mi(
    ...
    <li>
      <div class="rec_proprty">
        <div class="propertyImg"><img alt="<?= htmlspecialchars($baslik) ?>" src="<?php echo $baseurl_onyuz; ?><?= htmlspecialchars($kapak_resim) ?>" style="width: 100px;"></div>
        <div class="property_info" style="width: 55%;">
          <h4 style="line-height: 24px;"><a href="<?= htmlspecialchars($detay_url) ?>"><?= htmlspecialchars($baslik) ?></a></h4>
        ...
        <div class="property_details">
          ...
          <div class="property_widget wow fadeInUp">
			...
			<div class="list-group">
			  ...
			  <div class="list-group-item list-group-item-action flex-column align-items-start">
				<div class="d-flex w-100 justify-content-between">
					...
					<h5 class="mb-1 tarih-baslik-text">
						<b>Gidiş Tarihi:</b> <?= htmlspecialchars(formatTarih($paket_veri[0]['data']['ortak_alanlar']['tur_baslangic_tarihi'] ?? '')) ?>  
						Saat <?= htmlspecialchars($paket_veri[0]['data']['ortak_alanlar']['gidis_hava_yolu_saat'] ?? '') ?>
					</h5>
					
					<?php if ($gidis_aktif): ?>
						<small class="pc-hide">
							<a href="https://tr.flightaware.com/live/flight/<?= htmlspecialchars($paket_veri[0]['data']['ortak_alanlar']['gidis_hava_yolu_ucus_kodu'] ?? '') ?>" target="_blank">
								<i class="fa fa-plane" aria-hidden="true"></i>  
								Üçuş Kodu : <?= htmlspecialchars($paket_veri[0]['data']['ortak_alanlar']['gidis_hava_yolu_ucus_kodu'] ?? '') ?>
							</a>
						</small>
					<?php endif; ?>
				</div>
				<p class="mb-1"><i class="fa fa-plane" aria-hidden="true"></i>  <?= htmlspecialchars($gidis_hava_yolu[0]['data']['diller']['tr']['baslik'] ?? '') ?> ( <?= htmlspecialchars($paket_veri[0]['data']['ortak_alanlar']['tur_baslangic_tarihi_aciklama'] ?? '') ?> )</p>
					<?php if ($gidis_aktif): ?>
			  ...
			  <div class="list-group-item list-group-item-action flex-column align-items-start">
				<div class="d-flex w-100 justify-content-between">
				  <h5 class="mb-1 tarih-baslik-text"><b>Ara Geçiş Tarihi:</b> <?= htmlspecialchars(formatTarih($paket_veri[0]['data']['ortak_alanlar']['tur_ara_gecis_tarihi'] ?? '')) ?></h5>
				  <small class="text-muted"></small>
				</div>

				<p class="mb-1"><i class="fa fa-bus" aria-hidden="true"></i> ( <?= htmlspecialchars($paket_veri[0]['data']['ortak_alanlar']['tur_ara_gecis_tarihi_aciklama'] ?? '') ?> ) </p>
			  ...
			  <div class="list-group-item list-group-item-action flex-column align-items-start">
				<div class="d-flex w-100 justify-content-between">
					<h5 class="mb-1 tarih-baslik-text">
						<b>Dönüş Tarihi:</b> <?= htmlspecialchars(formatTarih($paket_veri[0]['data']['ortak_alanlar']['tur_bitis_tarihi'] ?? '')) ?>  
						Saat <?= htmlspecialchars($paket_veri[0]['data']['ortak_alanlar']['gelis_hava_yolu_saat'] ?? '') ?>
						
					</h5>
					<?php if ($donus_aktif): ?>
																	
						<small class="text-muted mobile-hide">
							<a href="https://tr.flightaware.com/live/flight/<?= htmlspecialchars($paket_veri[0]['data']['ortak_alanlar']['gelis_hava_yolu_ucus_kodu'] ?? '') ?>" target="_blank">
								<i class="fa fa-plane" aria-hidden="true"></i>  
								Üçuş Kodu : <?= htmlspecialchars($paket_veri[0]['data']['ortak_alanlar']['gelis_hava_yolu_ucus_kodu'] ?? '') ?>
							</a>
						</small>
					<?php endif; ?>
				</div>
				<p class="mb-1"><i class="fa fa-plane" aria-hidden="true"></i>  <?= htmlspecialchars($gelis_hava_yolu[0]['data']['diller']['tr']['baslik'] ?? '') ?> ( <?= htmlspecialchars($paket_veri[0]['data']['ortak_alanlar']['tur_bitis_tarihi_aciklama'] ?? '') ?> )</p>
					...
					<div class="list-group-item list-group-item-action flex-column align-items-start">
						<div class="d-flex w-100 justify-content-between">
							<h5 class="mb-1 tarih-baslik-text">
								<b>Toplam Tur Süresi:</b> <?php echo htmlspecialchars($konaklama_suresi); ?> dir.
							</h5>
							<small class="text-muted"></small>
						</div>
						...
						<p class="mb-1">
								...
								<i class="fa fa-info-circle" aria-hidden="true"></i> <?= htmlspecialchars($paket_veri[0]['data']['diller']['tr']['baslik'] ?? '') ?> Bilgilerini Görmek için Tıklayınız.
          ...
          <div class="property_widget wow fadeInUp">
             <h3 class="property_price"><?= htmlspecialchars($paket_veri[0]['data']['diller']['tr']['baslik'] ?? '') ?> Açıklaması</h3>
            <p><?= nl2br($paket_veri[0]['data']['diller']['tr']['aciklama']) ?></p>
          </div>         		  
       

			<div class="property_widget wow fadeInUp">
			  <h3 class="desc_head"><?= htmlspecialchars($paket_veri[0]['data']['diller']['tr']['baslik'] ?? '') ?> Otel Bilgileri</h3>
			  <ul class="row">
				<!--col-lg-4 Start-->
				<li class="<?= $ikinci_otel_goster ? 'col-lg-6' : 'col-lg-12' ?>">
				  <div class="property_box wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
					<div class="propertyImg"><img src="<?php echo $baseurl_onyuz; ?><?= htmlspecialchars($otel_bir['kapak_resim']) ?>" alt="<?= htmlspecialchars($otel_bir['veri'][0]['data']['diller']['tr']['baslik'] ?? 'Otel Adı') ?>"></div>
					<h3><?= htmlspecialchars($otel_bir['veri'][0]['data']['diller']['tr']['baslik'] ?? 'Otel Adı') ?></h3>
					<p style="height: 50px;"><b>Adres:</b> <?= htmlspecialchars($otel_bir['veri'][0]['data']['ortak_alanlar']['adres'] ?? 'Güncelleniyor') ?></p>
					<p><b>Telefon:</b> <?= htmlspecialchars($otel_bir['veri'][0]['data']['ortak_alanlar']['telefon'] ?? 'Güncelleniyor') ?></p>
			  
					<div class="rent_info">
					  <div class="apart"><i class="fas fa-map-marker-alt"></i> <?= htmlspecialchars($otel_bir['veri'][0]['data']['ortak_alanlar']['sehir'] ?? '') ?></div>
					  <a href="#" type="button" class="sale" data-toggle="modal" data-target="#otel_bir">Detay</a>
					</div>
				  </div>
				</li>
				<!--col-lg-4 End--> 
				...
				<li class="col-lg-6">
				  <div class="property_box wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
					<div class="propertyImg"><img src="<?php echo $baseurl_onyuz; ?><?= htmlspecialchars($otel_iki['kapak_resim']) ?>" alt="<?= htmlspecialchars($otel_iki['veri'][0]['data']['diller']['tr']['baslik'] ?? 'Otel Adı') ?>"></div>
					<h3><?= htmlspecialchars($otel_iki['veri'][0]['data']['diller']['tr']['baslik'] ?? 'Otel Adı') ?></h3>
					<p style="height: 50px;"><b>Adres:</b> <?= htmlspecialchars($otel_iki['veri'][0]['data']['ortak_alanlar']['adres'] ?? 'Adres bilgisi yok') ?></p>
					<p><b>Telefon:</b> <?= htmlspecialchars($otel_iki['veri'][0]['data']['ortak_alanlar']['telefon'] ?? 'Telefon bilgisi yok') ?></p>
			  
					<div class="rent_info">
					  <div class="apart"><i class="fas fa-map-marker-alt"></i> <?= htmlspecialchars($otel_iki['veri'][0]['data']['ortak_alanlar']['sehir'] ?? '') ?></div>
					  <a href="#" type="button" class="sale" data-toggle="modal" data-target="#otel_iki">Detay</a>
					</div>
				  </div>
				</li>
				<?php endif; ?>
          ...
          <div class="property_widget wow fadeInUp">
            <div class="floor_plans faqs">
              <div class="panel-group" id="accordion">
				...
				<h3 class="desc_head" id="tur-bilgileri"><?= htmlspecialchars($paket_veri[0]['data']['diller']['tr']['baslik'] ?? 'Başlık Güncelleniyor') ?> Tur Bilgileri</h3>
...
?>
        <div class="panel panel-default">
            ...
            <div id="collapsed<?php echo $bilgi_sayfa['id']; ?>" 
...
<div id="otel_bir" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="max-width: 728px;">
<div class="modal-header" style="background: #ffb900;">
        <h5 class="modal-title" style="color: #fff; font-weight: 600;"><?= htmlspecialchars($otel_bir['veri'][0]['data']['diller']['tr']['baslik'] ?? 'Otel Adı') ?></h5>
	  ...
	  <div class="modal-body">
				...
				<ul id="image-gallery-2" class="gallery list-unstyled cS-hidden" style="height: 530px;">
					...
					<?= $otel_bir['veri'][0]['data']['diller']['tr']['aciklama'] ?? ''; ?>
						...
						<p><?= htmlspecialchars($otel_bir['veri'][0]['data']['ortak_alanlar']['adres'] ?? 'Güncelleniyor') ?></p>
				
						</div>
						<div class="col-lg-6 col-md-6">
						<b>Telefon:</b>
						<p><?= htmlspecialchars($otel_bir['veri'][0]['data']['ortak_alanlar']['telefon'] ?? 'Güncelleniyor') ?></p>	
						<b>Email:</b>
						<p><?= htmlspecialchars($otel_bir['veri'][0]['data']['ortak_alanlar']['email'] ?? 'Güncelleniyor') ?></p>							
						...
						<div style="margin-top: 13px;">
							...
							<a href="<?= !empty($harita_link) ? htmlspecialchars($harita_link) : '#' ?>" 
							   target="_blank" 
							...
							<a href="<?= !empty($yol_tarifi) ? htmlspecialchars($yol_tarifi) : '#' ?>" 
							   target="_blank" 
...
<div id="otel_iki" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="max-width: 728px;">
<div class="modal-header" style="background: #ffb900;">
        <h5 class="modal-title" style="color: #fff; font-weight: 600;"><?= htmlspecialchars($otel_iki['veri'][0]['data']['diller']['tr']['baslik'] ?? 'Otel Adı') ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
	  <div class="modal-body">
				...
				<br>
					...
					<br>
						...
						<p><?= htmlspecialchars($otel_iki['veri'][0]['data']['ortak_alanlar']['adres'] ?? 'Güncelleniyor') ?></p>
				
						</div>
						<div class="col-lg-6 col-md-6">
						<b>Telefon:</b>
						<p><?= htmlspecialchars($otel_iki['veri'][0]['data']['ortak_alanlar']['telefon'] ?? 'Güncelleniyor') ?></p>	
						<b>Email:</b>
						<p><?= htmlspecialchars($otel_iki['veri'][0]['data']['ortak_alanlar']['email'] ?? 'Güncelleniyor') ?></p>							
						...
						?>			
								...
								<iframe src="<?php echo $iframe_kod; ?>" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
						</div>
						<div style="margin-top: 13px;">
							<a href="<?= htmlspecialchars($otel_iki['veri'][0]['data']['ortak_alanlar']['harita_link'] ?? 'Güncelleniyor') ?>" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-search-plus"></i> Google Haritalarda Göster</a>
							<a href="<?= htmlspecialchars($otel_iki['veri'][0]['data']['ortak_alanlar']['yol_tarifi'] ?? 'Güncelleniyor') ?>" target="_blank" class="btn btn-warning btn-sm"><i class="fa fa-directions"></i> Yol Tarifi Al</a>
							<a href="https://api.whatsapp.com/send?text=<?= htmlspecialchars($otel_bir['veri'][0]['data']['ortak_alanlar']['sehir'] ?? 'Güncelleniyor') ?>: <?= $otel_iki['veri'][0]['data']['diller']['tr']['baslik'] ?? ''; ?> Haritalardaki Konumu <?= htmlspecialchars($otel_iki['veri'][0]['data']['ortak_alanlar']['harita_link'] ?? 'Güncelleniyor') ?>" target="_blank" class="btn btn-success btn-sm"> <i class="fab fa-whatsapp" aria-hidden="true"></i> Haritayı Paylaş</a>
						</div>
...
<div id="yorum-yap" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				...
				<div class="row"> 
				  ...
				  <div class="col-lg-12">
					<div class="form-check">
					  <input type="checkbox" class="form-check-input" id="kvkk-yorum_yap" name="kvkk" required>
					  <label class="form-check-label" for="kvkk">
						<span id="kvkkLink" data-toggle="modal" data-target=".bd-example-modal-lg iletisim-modal" span><small>Kişisel verilerin işlenmesine ilişkin Aydınlatma Metnini. Okudum Onaylıyorum</small></a> .
					  </label>
				  ...
				  <div class="col-lg-12">
					<div class="form-check">
					  <input type="checkbox" class="form-check-input" id="haber-duyuru" name="haber-duyuru-onay" value="1">
					  <label class="form-check-label" for="haber-duyuru-onay"> <small>Haber Ve duyurulardan haberdar olmak İstiyorum. </small></label>
					  <div class="invalid-feedback"></div>
					</div>
				  </div>
...
<div id="bilgi-iste" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
<div class="modal-header" style="background: #ffb900;">
				...
				<div class="row"> 
				  ...
				  <div class="col-lg-12">
					<div class="form-group">
					  ...
					  <input id="form_email" class="form-control" type="email" name="email" placeholder="Email Adresiniz">
				  ...
				  <div class="col-lg-12">
					<div class="form-check">
					  <input type="checkbox" class="form-check-input" id="kvkk-bilgi" name="kvkk" required>
					  <label class="form-check-label" for="kvkk">
						<span id="kvkkLink" data-toggle="modal" data-target=".bd-example-modal-lg iletisim-modal" span><small>Kişisel verilerin işlenmesine ilişkin Aydınlatma Metnini. Okudum Onaylıyorum</small></a> .
					  </label>
