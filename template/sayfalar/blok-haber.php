...
$stmt = $pdo->prepare("SELECT veri FROM sayfalar WHERE id = 39");
$stmt->execute();
...
if ($row) {
    ...
    if (isset($sayfa_veri[0]['diller']['tr'])) {
        ...
        $sayfa_baslik = $tr_data['baslik'] ?? 'Blok, Haber, Makale';
...
<li class="list-group-item d-flex justify-content-between align-items-center">
  ...
  <a href="<?php echo $baseurl_onyuz.'blok-haber-detay/'.$id.'/'.$link; ?>"><?php echo $baslik; ?></a>
