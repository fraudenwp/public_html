...
<head>
    ...
    <?php
    // Canonical URL - PageData'dan kontrol et, yoksa mevcut mantığı kullan
    $canonical_url = PageData::get('canonical');

    if (empty($canonical_url)) {
        // Query string olmadan temiz URL
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W9WWKKNJ" height="0" width="0"
    ...
    try {
        ...
        if ($row) {
            ...
            <style>
                .topbar-wrap {
                    background:
                        <?php echo $ust_bar_renk; ?>
                    ;
                }

                .form_sec {
                    background:
                        <?php echo $search_bar_renk; ?>
                    ;
                }

                .footer {
                    background:
                        <?php echo $footer_bar_renk; ?>
                    ;
                }

                .sbutn {
                    background:
                        <?php echo $genel_buton_renk; ?>
                    ;
                    color:
                        <?php echo $genel_buton_yazi_renk; ?>
                    ;
                }
                ...
                .apart {
                    background:
                        <?php echo $liste_sayfa_renk_bir; ?>
                    ;
                    color:
                        <?php echo $liste_sayfa_renk_bir_yazi; ?>
                    ;
                }
                ...
                .sale {
                    background:
                        <?php echo $liste_sayfa_renk_iki; ?>
                    ;
                    color:
                        <?php echo $liste_sayfa_renk_iki_yazi; ?>
                    ;
                }
                ...
                .advanceWrp h4 a {
                    color:
                        <?php echo $liste_sayfa_renk_filtre_baslik; ?>
                        !important;
                }

                .custom-checkboxx+label:before {
                    border: 1px solid
                        <?php echo $liste_sayfa_renk_filtre_secim; ?>
                    ;
                    background: #ffffff;
                }
                ...
                .property_price {
                    color:
                        <?php echo $detay_sayfa_baslik_yazı_rengi; ?>
                    ;
                }
                ...
                .faqs h4 a {
                    ...
                    background:
                        <?php echo $detay_sayfa_bilgi_arkaplan_rengi; ?>
                    ;
                    color:
                        <?php echo $detay_sayfa_bilgi_baslik_yazi_rengi; ?>
                    ;
                }
            </style>
