...
$query = $pdo->query("SELECT id, yayin_durumu, baslik FROM kategoriler"); $kategori_list = $query->fetchAll(PDO::FETCH_ASSOC);
      ...
      <div class="container-fluid">
			...
			if ($table && $id) {
				function getOrtakVeriler($grup) {
					global $pdo;
					$query = $pdo->prepare("SELECT kat_id, yayin_durumu FROM urunler WHERE grup = :grup LIMIT 1");
	  ...
	  <form id="veriForm">
		...
		<div class="form-group">
			...
			<select class="custom-select" name="kat_id">                                    
				...
				<?php foreach ($kategori_list as $kategori): ?>
					<option value="<?php echo $kategori['id']; ?>" <?php echo ($ortakVeriler['kat_id'] == $kategori['id']) ? 'selected' : ''; ?>>
		...
		<div class="form-group">
			<label for="resim">Resim</label>
				<input type="file" name="resim"  data-resim-tablosu="urun_resim" data-hedef-dizin="resimler/kategoriler" data-resim-en="100" data-resim-boy="100" data-resim-kalite="75" class="form-control" id="dosyaYukleInput" multiple>
		</div>								
			...
			<div class="col-md-12">
				...
				<div class="card card-primary">
					<div class="card-body">
						<div class="row">
							<div class="col-8">	
									<input type="submit" class="btn btn-primary float-left" value="Düzenle" data-sifrele="" data-form-turu="veri-duzenle" data-tablo-adi="urunler" data-sifrele-aes="aes" data-sifrele-md5="md5">	
							</div> 					
							<div class="col-4">								
