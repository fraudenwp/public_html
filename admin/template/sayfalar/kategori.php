							...
							<div class="col-2">
								<div class="form-group">
									...
									<div class="col-2">
										<div class="form-group">
											<div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
												<input type="checkbox" class="custom-control-input" id="filtre_menu" name="filtre_menu" value="1" data-json_ortak_alan="evet">
												<label class="custom-control-label" for="filtre_menu">Filtre Alanında Göster</label>
											</div>
										</div>			  
									</div>							
								...
								<div class="card card-primary card-outline">
						<div class="card-header">
						<h3 class="card-title"><b>Alt Açıklama</b></h3>
						</div>
						<div class="card-body">		
							<div class="row">
								...
								<div class="col-12">	
								<div class="form-group">
									<label for="alt_aciklama">Alt Açıklama</label>
									<textarea class="summernote" id="alt_aciklama" name="alt_aciklama" data-json_ortak_alan="evet"></textarea>
								</div>	
								</div>	
					...
					<div class="tab-pane fade" id="medya-ekle" role="tabpanel" aria-labelledby="medya-ekle-tab">
						<div class="form-group" id="resim-upload-area">
							...
							<input type="file" id="file-input" class="form-control" name="dosya_adi[]" 
								   data-resim_eni="540" 
								   data-resim_boyu="230" 
								   data-resim_kayit_dizini="resimler/kategori/" 
...
<div class="modal fade" id="SayfaAyarModal" 
     ...
     data-sayfa_ayar_tablo_satir_id="23"
...
<?php
// Sorguyu hazırla
$sql = "SELECT veri, yayin_durumu FROM sayfalar WHERE id = 23";
