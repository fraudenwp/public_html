					...
					<div class="tab-pane fade show active" id="genel-ekle" role="tabpanel" aria-labelledby="genel-ekle-tab">
						...
						<div class="card card-primary card-outline">
							...
							<div class="card-body">		
								...
								<div class="form-group">
								<label for="medya_galeri">Üst Kategori Seç <small>(Ana Kategori Olacaksa Boş Bırakın)</small></label>
									<select class="form-control select2" id="medya_galeri" name="medya_galeri" data-select_tablo_adi="medya_galeri" data-json_ortak_alan="evet" multiple>
								</select> 
								</div>											
						...
						<div class="card card-primary card-outline">
							<div class="card-header">
							<h3 class="card-title"><b>Menülerde Göster Veya Gizle</b></h3>
							</div>
							<div class="card-body">		
								<div class="row">
									<div class="col-3">
										<div class="form-group">
											<div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
												<input type="checkbox" class="custom-control-input" id="alt_menu" name="alt_menu" value="1" data-json_ortak_alan="evet">
												<label class="custom-control-label" for="alt_menu">Alt Menüde Göster</label>
											</div>
										</div>			  
									</div>
									<div class="col-3">
										<div class="form-group">
											<div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
												<input type="checkbox" class="custom-control-input" id="ust_menu" name="ust_menu" value="1" data-json_ortak_alan="evet">
												<label class="custom-control-label" for="ust_menu">Üst Menüde Göster</label>
											</div>
										</div>			  
									</div>
									<div class="col-3">
									...
									<div class="col-3">
										<div class="form-group">
											<div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
												<input type="checkbox" class="custom-control-input" id="medya_gizle" name="medya_gizle" value="1" data-json_ortak_alan="evet">
												<label class="custom-control-label" for="medya_gizle">Medya Listesinde Gizle</label>
											</div>
										</div>			  
									</div>
									<div class="col-3">
					...
					<div class="tab-pane fade" id="medya-ekle" role="tabpanel" aria-labelledby="medya-ekle-tab">
						<div class="form-group" id="resim-upload-area">
							...
							<input type="file" id="file-input" class="form-control" name="dosya_adi[]" 
								   data-resim_eni="0" 
								   data-resim_boyu="0" 
								   data-resim_kayit_dizini="resimler/medya_galeri/" 
