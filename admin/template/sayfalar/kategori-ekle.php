			...
			<div class="col-md-12">
				...
				<div class="card card-primary">
					<div class="card-body">
						<div class="row">
							<div class="col-8">	
								<input type="submit" class="btn btn-primary float-left" value="Kaydet" data-sifrele="" data-form-turu="veri_ekle" data-tablo-adi="kategoriler" data-sifrele-aes="aes" data-sifrele-md5="md5">	
							</div> 					
							<div class="col-4">								
