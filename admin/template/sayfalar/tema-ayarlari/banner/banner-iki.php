...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h3 class="card-title">#<?php echo $veri_id; ?> Banner 1 (Üç resim yan yana) </h3>
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-body">
		  <form id="ekleForm" enctype="multipart/form-data">
			...
			<div class="form-group">
			  ...
			  <input type="file" data-resim_en="690" data-name="Resim" data-resim_boy="200" data-resim_doldur="false" data-resim_kirp="true" data-resim_turu="png" data-resim_yolu="../../resimler/slide/" class="form-control" name="resim">
			</div>
		...
		<div class="modal-footer">
		  ...
		  <button type="button" id="KaydetButon" data-formturu="veri-ekle" data-tabloadi="tema" data-sutun-adi="tur" data-satir-adi="banner-iki" class="btn btn-primary">Kaydet</button>
		</div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="SilButon" data-formturu="veri-sil" data-tabloadi="tema" data-sutun-adi="tur" data-satir-adi="banner-iki"  class="btn btn-primary">Evet</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-footer">
		  <button type="button" class="btn btn-secondary" data-dismiss="modal">Kapat</button>
		  <button type="button" id="GuncelleButon" data-formturu="veri-guncelle" data-tabloadi="tema" data-sutun-adi="tur" data-satir-adi="banner-iki" class="btn btn-primary">Güncelle</button>
		</div>
    </div>
  </div>
</div>
