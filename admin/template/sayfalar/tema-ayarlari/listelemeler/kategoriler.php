...
function getCellContent($key, $value, $id, $tablo_adi, $sutun_adi, $satir_adi, $user_dil, $pdo) {
    switch ($key) {
        ...
        case 'Başlık':
            ...
            return "<td>" . htmlspecialchars($kategori['baslik'] ?? 'Kategori Bulunamadı') . "</td>";
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-body">
		  <form id="ekleForm" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<select class="form-control select2bs4" style="width: 100%;" name="kategori" data-name="kategori" multiple>
		...
		<div class="modal-footer">
		  ...
		  <button type="button" id="KaydetButon" data-formturu="veri-ekle" data-tabloadi="tema" data-sutun-adi="tur" data-satir-adi="Listele-Bir" class="btn btn-primary">Kaydet</button>
		</div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="SilButon" data-formturu="veri-sil" data-tabloadi="tema" data-sutun-adi="tur" data-satir-adi="Listele-Bir"  class="btn btn-primary">Evet</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-footer">
		  <button type="button" class="btn btn-secondary" data-dismiss="modal">Kapat</button>
		  <button type="button" id="GuncelleButon" data-formturu="veri-guncelle" data-tabloadi="tema" data-sutun-adi="tur" data-satir-adi="Listele-Bir" class="btn btn-primary">Güncelle</button>
		</div>
    </div>
  </div>
</div>
