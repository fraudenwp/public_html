    ...
    <div class="content"> 
      ...
      <div class="container-fluid">
            ...
            <div class="col-md-12" id="sayfa-cek" 
                 ...
                 data-tablo_adi="mesajlar" 
                 data-sutun_adi="veri" 
                 data-json_sutun_adi="mesaj_tarih, mesaj_turu, baslik, konu, telefon, email, yayin_durumu" 
                 data-tablo_basliklari="Tarih, Mesaj Türü, Gönderen, Konu, Telefon, Email, Okundu" 
                 data-ek_form="evet"  
                 data-user_dil="tr">
            </div>
					...
					<div class="tab-pane fade show active" id="genel-ekle" role="tabpanel" aria-labelledby="genel-ekle-tab">
						...
						<?php foreach ($diller as $index => $dil): ?>
							<div class="tab-pane fade <?php echo $index === 0 ? 'show active' : ''; ?>" id="dil-<?php echo $dil['kod']; ?>" role="tabpanel" aria-labelledby="dil-<?php echo $dil['kod']; ?>-tab">
								...
								<div class="form-group">
									<label for="konu_<?php echo $dil['kod']; ?>">Konu</label>
									<input type="text" class="form-control" id="konu_<?php echo $dil['kod']; ?>" name="konu_<?php echo $dil['kod']; ?>" data-form_bos_kontrol="evet" disabled>								
								</div>
							...
							<div class="col-4">
								<div class="form-group">
									<label for="telefon_<?php echo $dil['kod']; ?>">Telefon</label>
									<input type="text" class="form-control" id="telefon_<?php echo $dil['kod']; ?>" name="telefon_<?php echo $dil['kod']; ?>" data-form_bos_kontrol="evet" disabled>								
								</div>	
								<div class="form-group">
									<label for="email_<?php echo $dil['kod']; ?>">Email</label>
									<input type="text" class="form-control" id="email_<?php echo $dil['kod']; ?>" name="email_<?php echo $dil['kod']; ?>" data-form_bos_kontrol="evet" disabled>								
								</div>								
								<div class="form-group">
